      ...
      <Card className="mb-8 shadow-sm border-border overflow-hidden rounded-xl">
        ...
        <CardContent className="p-6 space-y-8">
          <div className="space-y-5">
            ...
            <PizzaStyleSwitch pizzaStyle={pizzaStyle} setPizzaStyle={setPizzaStyle} />
          </div>
          ...
          <div className="space-y-5">
            ...
            <FermentationMethodSelect fermentationMethod={fermentationMethod} onChange={setFermentationMethod} />
          </div>
