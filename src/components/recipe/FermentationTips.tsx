  ...
  <div className="bg-pizza-light bg-opacity-30 p-4 rounded-lg">
    ...
    {method === 'direct' && (
      <p className="text-sm text-gray-700">
        Allow the dough to ferment for 8-24 hours at room temperature (20-22°C) or in the refrigerator for longer. 
        The dough should double in volume and develop a characteristic aroma.
      </p>
    )}
    {method === 'poolish' && (
      <p className="text-sm text-gray-700">
        After incorporating the poolish into the final dough, allow to ferment for 4-6 hours at room temperature.
        This method gives lightness and complex flavor to the dough.
      </p>
    )}
    {method === 'biga' && (
      <p className="text-sm text-gray-700">
        After incorporating the biga, allow to ferment for 3-5 hours. This method provides strength to the dough and a more intense flavor.
